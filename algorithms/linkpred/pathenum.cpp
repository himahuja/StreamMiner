...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "algorithms/linkpred/pathenum.pyx"
        ]
    }, 
    "module_name": "algorithms.linkpred.pathenum"
}
END: Cython Metadata */
...
#define __PYX_HAVE__algorithms__linkpred__pathenum
#define __PYX_HAVE_API__algorithms__linkpred__pathenum
/* Early includes */
#include <string.h>
#include <stdio.h>
...
struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_get_paths;
struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_enumerate_paths;

/* "algorithms/linkpred/pathenum.pxd":3
 * cimport cython
 * 
...
/* "algorithms/linkpred/pathenum.pxd":5
 * cpdef get_paths(G, s, p, o, length=*, maxpaths=*)
 * 
 * cdef object enumerate_paths(             # <<<<<<<<<<<<<<
...
/* Module declarations from 'algorithms.linkpred.pathenum' */
...
static PyObject *__pyx_f_10algorithms_8linkpred_8pathenum_get_paths(PyObject *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_get_paths *__pyx_optional_args); /*proto*/
static PyObject *__pyx_f_10algorithms_8linkpred_8pathenum_enumerate_paths(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int, struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_enumerate_paths *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "algorithms.linkpred.pathenum"
extern int __pyx_module_is_main_algorithms__linkpred__pathenum;
int __pyx_module_is_main_algorithms__linkpred__pathenum = 0;

/* Implementation of 'algorithms.linkpred.pathenum' */
...
static PyObject *__pyx_pf_10algorithms_8linkpred_8pathenum_get_paths(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_G, PyObject *__pyx_v_s, PyObject *__pyx_v_p, PyObject *__pyx_v_o, PyObject *__pyx_v_length, PyObject *__pyx_v_maxpaths); /* proto */
...
/* "algorithms/linkpred/pathenum.pyx":22
...
static PyObject *__pyx_pw_10algorithms_8linkpred_8pathenum_1get_paths(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_10algorithms_8linkpred_8pathenum_get_paths(PyObject *__pyx_v_G, PyObject *__pyx_v_s, PyObject *__pyx_v_p, PyObject *__pyx_v_o, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_get_paths *__pyx_optional_args) {
  ...
  int __pyx_t_12;
  int __pyx_t_13;
  struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_enumerate_paths __pyx_t_14;
  ...
  /* "algorithms/linkpred/pathenum.pyx":30
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":31
 * 	# graph vectors
 * 	data = G.csr.data.astype(_float)
 * 	indices = G.csr.indices.astype(_int64)             # <<<<<<<<<<<<<<
 * 	indptr = G.csr.indptr.astype(_int)
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":32
 * 	data = G.csr.data.astype(_float)
 * 	indices = G.csr.indices.astype(_int64)
 * 	indptr = G.csr.indptr.astype(_int)             # <<<<<<<<<<<<<<
 * 	paths, relpaths = enumerate_paths(
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":34
 * 	indptr = G.csr.indptr.astype(_int)
 * 	paths, relpaths = enumerate_paths(
 * 		data, indices, indptr, s, p, o, length=length, maxpaths=maxpaths             # <<<<<<<<<<<<<<
 * 	)
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":33
 * 	indices = G.csr.indices.astype(_int64)
 * 	indptr = G.csr.indptr.astype(_int)
 * 	paths, relpaths = enumerate_paths(             # <<<<<<<<<<<<<<
 * 		data, indices, indptr, s, p, o, length=length, maxpaths=maxpaths
 ...
 */
  ...
  __pyx_t_1 = __pyx_f_10algorithms_8linkpred_8pathenum_enumerate_paths(__pyx_v_data, __pyx_v_indices, __pyx_v_indptr, __pyx_t_9, __pyx_t_10, __pyx_t_11, &__pyx_t_14); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "algorithms/linkpred/pathenum.pyx":37
 * 	)
 * 	# convert to Python objects
 * 	discovered_paths = []             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":38
 * 	# convert to Python objects
 * 	discovered_paths = []
 * 	for pth, rpth in zip(paths, relpaths):             # <<<<<<<<<<<<<<
 * 		pp = RelationalPath(s, p, o, 0., length, pth, rpth, np.ones(length + 1))
 ...
 */
  ...
  for (;;) {
    ...
    /* "algorithms/linkpred/pathenum.pyx":39
 * 	discovered_paths = []
 * 	for pth, rpth in zip(paths, relpaths):
 * 		pp = RelationalPath(s, p, o, 0., length, pth, rpth, np.ones(length + 1))             # <<<<<<<<<<<<<<
 * 		discovered_paths.append(pp)
 ...
 */
    ...
    #endif
    {
      ...
      PyTuple_SET_ITEM(__pyx_t_20, 4+__pyx_t_13, __pyx_v_length);
    ...
    /* "algorithms/linkpred/pathenum.pyx":40
 * 	for pth, rpth in zip(paths, relpaths):
 * 		pp = RelationalPath(s, p, o, 0., length, pth, rpth, np.ones(length + 1))
 * 		discovered_paths.append(pp)             # <<<<<<<<<<<<<<
 * 	return discovered_paths
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":41
 * 		pp = RelationalPath(s, p, o, 0., length, pth, rpth, np.ones(length + 1))
 * 		discovered_paths.append(pp)
 * 	return discovered_paths             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("algorithms.linkpred.pathenum.get_paths", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_10algorithms_8linkpred_8pathenum_1get_paths(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10algorithms_8linkpred_8pathenum_get_paths[] = "Returns all paths of length `length` starting at s and ending in o.";
static PyObject *__pyx_pw_10algorithms_8linkpred_8pathenum_1get_paths(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_10algorithms_8linkpred_8pathenum_get_paths(__pyx_self, __pyx_v_G, __pyx_v_s, __pyx_v_p, __pyx_v_o, __pyx_v_length, __pyx_v_maxpaths);
...
static PyObject *__pyx_pf_10algorithms_8linkpred_8pathenum_get_paths(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_G, PyObject *__pyx_v_s, PyObject *__pyx_v_p, PyObject *__pyx_v_o, PyObject *__pyx_v_length, PyObject *__pyx_v_maxpaths) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_get_paths __pyx_t_2;
  __Pyx_RefNannySetupContext("get_paths", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2.__pyx_n = 2;
  __pyx_t_2.length = __pyx_v_length;
  __pyx_t_2.maxpaths = __pyx_v_maxpaths;
  __pyx_t_1 = __pyx_f_10algorithms_8linkpred_8pathenum_get_paths(__pyx_v_G, __pyx_v_s, __pyx_v_p, __pyx_v_o, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "algorithms/linkpred/pathenum.pyx":48
...
static PyObject *__pyx_f_10algorithms_8linkpred_8pathenum_enumerate_paths(CYTHON_UNUSED __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_indices, __Pyx_memviewslice __pyx_v_indptr, int __pyx_v_s, CYTHON_UNUSED int __pyx_v_p, int __pyx_v_o, struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_enumerate_paths *__pyx_optional_args) {
  ...
  /* "algorithms/linkpred/pathenum.pyx":61
 * 		long[:] neighbors
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":62
 * 		np.ndarray paths_arr, relpaths_arr
 * 	N = len(indptr) - 1
 * 	tmp.push_back(s)             # <<<<<<<<<<<<<<
 * 	path_stack.push(tmp)
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":63
 * 	N = len(indptr) - 1
 * 	tmp.push_back(s)
 * 	path_stack.push(tmp)             # <<<<<<<<<<<<<<
 * 	tmp.clear()
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":64
 * 	tmp.push_back(s)
 * 	path_stack.push(tmp)
 * 	tmp.clear()             # <<<<<<<<<<<<<<
 * 	tmp.push_back(-1)
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":65
 * 	path_stack.push(tmp)
 * 	tmp.clear()
 * 	tmp.push_back(-1)             # <<<<<<<<<<<<<<
 * 	relpath_stack.push(tmp)
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":66
 * 	tmp.clear()
 * 	tmp.push_back(-1)
 * 	relpath_stack.push(tmp)             # <<<<<<<<<<<<<<
 * 	num_paths = 0
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":67
 * 	tmp.push_back(-1)
 * 	relpath_stack.push(tmp)
 * 	num_paths = 0             # <<<<<<<<<<<<<<
 * 	while path_stack.size() > 0:
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":68
 * 	relpath_stack.push(tmp)
 * 	num_paths = 0
 * 	while path_stack.size() > 0:             # <<<<<<<<<<<<<<
 * 		curr_path = path_stack.top()
 ...
 */
  while (1) {
    ...
    /* "algorithms/linkpred/pathenum.pyx":69
 * 	num_paths = 0
 * 	while path_stack.size() > 0:
 * 		curr_path = path_stack.top()             # <<<<<<<<<<<<<<
 * 		path_stack.pop()
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":70
 * 	while path_stack.size() > 0:
 * 		curr_path = path_stack.top()
 * 		path_stack.pop()             # <<<<<<<<<<<<<<
 * 		curr_relpath = relpath_stack.top()
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":71
 * 		curr_path = path_stack.top()
 * 		path_stack.pop()
 * 		curr_relpath = relpath_stack.top()             # <<<<<<<<<<<<<<
 * 		relpath_stack.pop()
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":72
 * 		path_stack.pop()
 * 		curr_relpath = relpath_stack.top()
 * 		relpath_stack.pop()             # <<<<<<<<<<<<<<
 * 		node = curr_path.back()
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":73
 * 		curr_relpath = relpath_stack.top()
 * 		relpath_stack.pop()
 * 		node = curr_path.back()             # <<<<<<<<<<<<<<
 * 		if curr_path.size() == length + 1:
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":74
 * 		relpath_stack.pop()
 * 		node = curr_path.back()
 * 		if curr_path.size() == length + 1:             # <<<<<<<<<<<<<<
 * 			if node == o:
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "algorithms/linkpred/pathenum.pyx":75
 * 		node = curr_path.back()
 * 		if curr_path.size() == length + 1:
 * 			if node == o:             # <<<<<<<<<<<<<<
 * 				discovered_paths.push_back(curr_path)
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "algorithms/linkpred/pathenum.pyx":76
 * 		if curr_path.size() == length + 1:
 * 			if node == o:
 * 				discovered_paths.push_back(curr_path)             # <<<<<<<<<<<<<<
 * 				discovered_relpaths.push_back(curr_relpath)
 ...
 */
        ...
        /* "algorithms/linkpred/pathenum.pyx":77
 * 			if node == o:
 * 				discovered_paths.push_back(curr_path)
 * 				discovered_relpaths.push_back(curr_relpath)             # <<<<<<<<<<<<<<
 * 				num_paths += 1
 ...
 */
        ...
        /* "algorithms/linkpred/pathenum.pyx":78
 * 				discovered_paths.push_back(curr_path)
 * 				discovered_relpaths.push_back(curr_relpath)
 * 				num_paths += 1             # <<<<<<<<<<<<<<
 * 				if maxpaths != -1 and num_paths > maxpaths:
 ...
 */
        ...
        /* "algorithms/linkpred/pathenum.pyx":79
 * 				discovered_relpaths.push_back(curr_relpath)
 * 				num_paths += 1
 * 				if maxpaths != -1 and num_paths > maxpaths:             # <<<<<<<<<<<<<<
 * 					break
 ...
 */
        ...
        __pyx_t_3 = ((__pyx_v_num_paths > __pyx_v_maxpaths) != 0);
        __pyx_t_2 = __pyx_t_3;
        __pyx_L8_bool_binop_done:;
        if (__pyx_t_2) {

          /* "algorithms/linkpred/pathenum.pyx":80
 * 				num_paths += 1
 * 				if maxpaths != -1 and num_paths > maxpaths:
 * 					break             # <<<<<<<<<<<<<<
 * 			continue
 ...
 */
      ...
      /* "algorithms/linkpred/pathenum.pyx":81
 * 				if maxpaths != -1 and num_paths > maxpaths:
 * 					break
 * 			continue             # <<<<<<<<<<<<<<
 * 		start = indptr[node]
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":82
 * 					break
 * 			continue
 * 		start = indptr[node]             # <<<<<<<<<<<<<<
 * 		end = indptr[node + 1]
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":83
 * 			continue
 * 		start = indptr[node]
 * 		end = indptr[node + 1]             # <<<<<<<<<<<<<<
 * 		neighbors = indices[start:end] # nbrs in wide-CSR
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":84
 * 		start = indptr[node]
 * 		end = indptr[node + 1]
 * 		neighbors = indices[start:end] # nbrs in wide-CSR             # <<<<<<<<<<<<<<
 * 		N_neigh = end - start
...
__PYX_XDEC_MEMVIEW(&__pyx_v_neighbors, 1);
    ...
    /* "algorithms/linkpred/pathenum.pyx":85
 * 		end = indptr[node + 1]
 * 		neighbors = indices[start:end] # nbrs in wide-CSR
 * 		N_neigh = end - start             # <<<<<<<<<<<<<<
 * 		for i in xrange(N_neigh):
 ...
 */
    ...
    /* "algorithms/linkpred/pathenum.pyx":86
 * 		neighbors = indices[start:end] # nbrs in wide-CSR
 * 		N_neigh = end - start
 * 		for i in xrange(N_neigh):             # <<<<<<<<<<<<<<
 * 			nbr = neighbors[i] % N # predecessor vec
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      ...
      /* "algorithms/linkpred/pathenum.pyx":87
 * 		N_neigh = end - start
 * 		for i in xrange(N_neigh):
 * 			nbr = neighbors[i] % N # predecessor vec             # <<<<<<<<<<<<<<
 * 			rel = (neighbors[i] - nbr) / N # relation vec
 ...
 */
      ...
      /* "algorithms/linkpred/pathenum.pyx":88
 * 		for i in xrange(N_neigh):
 * 			nbr = neighbors[i] % N # predecessor vec
 * 			rel = (neighbors[i] - nbr) / N # relation vec             # <<<<<<<<<<<<<<
 * 			curr_path.push_back(nbr)
 ...
 */
      ...
      /* "algorithms/linkpred/pathenum.pyx":89
 * 			nbr = neighbors[i] % N # predecessor vec
 * 			rel = (neighbors[i] - nbr) / N # relation vec
 * 			curr_path.push_back(nbr)             # <<<<<<<<<<<<<<
 * 			path_stack.push(curr_path)
 ...
 */
      ...
      /* "algorithms/linkpred/pathenum.pyx":90
 * 			rel = (neighbors[i] - nbr) / N # relation vec
 * 			curr_path.push_back(nbr)
 * 			path_stack.push(curr_path)             # <<<<<<<<<<<<<<
 * 			curr_path.pop_back()
 ...
 */
      ...
      /* "algorithms/linkpred/pathenum.pyx":91
 * 			curr_path.push_back(nbr)
 * 			path_stack.push(curr_path)
 * 			curr_path.pop_back()             # <<<<<<<<<<<<<<
 * 			curr_relpath.push_back(rel)
 ...
 */
      ...
      /* "algorithms/linkpred/pathenum.pyx":92
 * 			path_stack.push(curr_path)
 * 			curr_path.pop_back()
 * 			curr_relpath.push_back(rel)             # <<<<<<<<<<<<<<
 * 			relpath_stack.push(curr_relpath)
 ...
 */
      ...
      /* "algorithms/linkpred/pathenum.pyx":93
 * 			curr_path.pop_back()
 * 			curr_relpath.push_back(rel)
 * 			relpath_stack.push(curr_relpath)             # <<<<<<<<<<<<<<
 * 			curr_relpath.pop_back()
 ...
 */
      ...
      /* "algorithms/linkpred/pathenum.pyx":94
 * 			curr_relpath.push_back(rel)
 * 			relpath_stack.push(curr_relpath)
 * 			curr_relpath.pop_back()             # <<<<<<<<<<<<<<
 * 	return discovered_paths, discovered_relpaths
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":95
 * 			relpath_stack.push(curr_relpath)
 * 			curr_relpath.pop_back()
 * 	return discovered_paths, discovered_relpaths             # <<<<<<<<<<<<<<
 * 
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_12 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_int_3e___(__pyx_v_discovered_paths); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_13 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_int_3e___(__pyx_v_discovered_relpaths); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 95, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("algorithms.linkpred.pathenum.enumerate_paths", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_neighbors, 1);
  __Pyx_XGIVEREF(__pyx_r);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "algorithms.linkpred.pathenum.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "algorithms.linkpred.pathenum.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "algorithms.linkpred.pathenum.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "algorithms.linkpred.pathenum._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_paths", (PyCFunction)__pyx_pw_10algorithms_8linkpred_8pathenum_1get_paths, METH_VARARGS|METH_KEYWORDS, __pyx_doc_10algorithms_8linkpred_8pathenum_get_paths},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_pathenum(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_pathenum},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("get_paths", (void (*)(void))__pyx_f_10algorithms_8linkpred_8pathenum_get_paths, "PyObject *(PyObject *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_get_paths *__pyx_optional_args)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("enumerate_paths", (void (*)(void))__pyx_f_10algorithms_8linkpred_8pathenum_enumerate_paths, "PyObject *(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int, struct __pyx_opt_args_10algorithms_8linkpred_8pathenum_enumerate_paths *__pyx_optional_args)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpathenum(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpathenum(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_pathenum(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_pathenum(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_pathenum(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_pathenum(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_algorithms__linkpred__pathenum) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "algorithms.linkpred.pathenum")) {
      if (unlikely(PyDict_SetItemString(modules, "algorithms.linkpred.pathenum", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "algorithms/linkpred/pathenum.pyx":2
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":4
 * import numpy as np
 * 
 * from datastructures.relationalpath import RelationalPath             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":14
 * 
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":15
 * # data types for int and float
 * _short = np.int16
 * _int = np.int32             # <<<<<<<<<<<<<<
 * _int64 = np.int64
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":16
 * _short = np.int16
 * _int = np.int32
 * _int64 = np.int64             # <<<<<<<<<<<<<<
 * _float = np.float
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":17
 * _int = np.int32
 * _int64 = np.int64
 * _float = np.float             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "algorithms/linkpred/pathenum.pyx":1
 * # cython: profile=False             # <<<<<<<<<<<<<<
 * import numpy as np
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init algorithms.linkpred.pathenum", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init algorithms.linkpred.pathenum");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
